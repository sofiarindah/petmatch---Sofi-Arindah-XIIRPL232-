...
<style>
    body {
        /* Warna background krem lembut */
        background: #fdf8f5;
        font-family: 'Poppins', sans-serif;
    }
    .pastel-card {
        background: #ffffff;
        border-radius: 30px; /* Lebih bulat agar terlihat 'soft' */
    ...
    .bubble-title {
        background: #ece0d1; /* Coklat pastel muda */
        color: #634832; /* Coklat tua hangat */
    ...
    .btn-pastel {
        ...
        font-weight: 800;
        padding: 12px 30px;
        background: #967e76; /* Coklat susu / Earth tone */
        color: white;
        border: none;
    ...
    .badge-diterima { background-color: #e2f0d9; color: #70a1ff; } /* Sesuai selera */
        ...
        <form method="POST" action="{{ route('user.permintaan.store') }}">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-4">
                    ...
                    <input type="text" name="pekerjaan" class="form-control"
                           placeholder="Pekerjaan/Kesibukan" required>
                </div>
            </div>
            ...
            <div class="mb-5">
                ...
                <textarea name="alasan" class="form-control" rows="3"
                          placeholder="Ceritakan alasan kenapa anda ingin mengadopsi hewan ini..." required></textarea>
            </div>

            <div class="text-center">
                <button class="btn btn-pastel btn-lg w-100 w-md-auto">
                    Kirim Permintaan
                </button>
            </div>
        </form>
